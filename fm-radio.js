...
if (2 == mrx24gx.length) {
    (function(d, q) {
        ...
        e.play = function() {
            var a = e.objectId,
                b = e.jsInstances;
            if (null != t[a] ? b.existsReserved(a) : b.h.hasOwnProperty(a)) a =
                e.objectId, b = e.jsInstances, (null != t[a] ? b.getReserved(a) : b.h[a]).playAudio();
            a = e.objectId;
            b = e.flashInstances;
        ...
        e.stop = function() {
            ...
            b = e.flashInstances;
            if (null != t[a] ? b.existsReserved(a) : b.h.hasOwnProperty(a)) a =
                e.objectId, b = e.flashInstances, (null != t[a] ? b.getReserved(a) : b.h[a]).stopSound()
        };
        ...
        e.setUrl = function(a) {
            ...
            b = e.objectId;
            c = e.flashInstances;
            if (null != t[b] ? c.existsReserved(b) : c.h.hasOwnProperty(b)) b = e.objectId, c = e.flashInstances, (null != t[b] ? c.getReserved(b) :
                c.h[b]).setUrl(a)
        };
        ...
        e.insert = function(a) {
            1 == a.forceFlash ? e.flashInsert(a) : 0 < e.isIE() && 11 > e.isIE() ? (console.log("MusesRadioPlayer will use Flash Version here since you have Internet Explorer " + e.isIE() + " (wich is older than IE 11)."), e.flashInsert(a)) : 0 < e.isIE() && 11 <= e.isIE() && "aac" == a.codec && FlashDetect.versionAtLeast(10,
                ...
                a.codec + " codec and you don't have flash plugin installed!"), e.jsInsert(a))
        };
        ...
        e.flashInsert = function(a) {
            ...
            b += "&codec=" + a.codec;
            b = b + "&tracking=true" + ("&volume=" +
                (null != a.volume ? a.volume : 100));
        ...
        h.prototype = {
            ...
            set: function(a, b) {
                if (this.nodeType !=
                    h.Element) throw new p("Bad node type, expected Element but found " + this.nodeType);
            ...
            addChild: function(a) {
                if (this.nodeType != h.Document && this.nodeType != h.Element) throw new p("Bad node type, expected Element or Document but found " +
                    this.nodeType);
                ...
                var c = this.req = Ea.createXMLHttpRequest(),
                    g = function(a) {
                        if (4 == c.readyState) {
                            ...
                            null != g && "undefined" !== typeof window && (a = window.location.protocol.toLowerCase(), (new D("^(?:about|app|app-storage|.+-extension|file|res|widget):$", "")).match(a) && (g = null != c.responseText ?
                                200 : 404));
                            void 0 == g && (g = null);
            ...
            for (var g = null, f = 1, e = 1, k = null, n = 0, w = 0, u = 0, m = a.charCodeAt(c), l = new N, q = 1, v = -1; m == m;) {
                switch (f) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        if (!(97 <= m && 122 >= m || 65 <= m && 90 >= m || 48 <= m && 57 >= m || 58 ==
                                m || 46 == m || 95 == m || 45 == m)) {
                    ...
                    case 8:
                        switch (m) {
                            ...
                            case 60:
                            case 62:
                                if (b) throw new p(new A("Invalid unescaped " +
                                    String.fromCharCode(m) + " in attribute value", a, c));
                    ...
                    case 10:
                        if (!(97 <= m && 122 >= m || 65 <= m && 90 >= m || 48 <= m && 57 >= m || 58 == m || 46 == m || 95 == m || 45 == m)) {
                            ...
                            e = r.substr(a, n, c - n);
                            if (d.nodeType != h.Element) throw new p("Bad node type, expected Element but found " +
                                d.nodeType);
                            if (e != d.nodeName) {
                                if (d.nodeType != h.Element) throw new p("Bad node type, expected Element but found " + d.nodeType);
                    ...
                    case 12:
                        ...
                        throw new p(new A("Expected >", a, c));
                    case 13:
                        60 == m ? (e = c - n, l.b += null == e ? r.substr(a, n, null) : r.substr(a, n, e), e = h.createPCData(l.b), l = new N, d.addChild(e), ++w, f = 0, e = 2) : 38 ==
                            m && (q = c - n, l.b += null == q ? r.substr(a, n, null) : r.substr(a, n, q), f = 18, q = 13, n = c + 1);
                        break;
                    case 14:
                    ...
                    case 16:
                        ...
                        break;
                    case 17:
                        93 == m && 93 == a.charCodeAt(c + 1) && 62 == a.charCodeAt(c + 2) &&
                            (m = h.createCData(r.substr(a, n, c - n)), d.addChild(m), ++w, c += 2, f = 1);
                        break;
                    case 18:
                        if (59 == m) {
                            n = r.substr(a, n, c - n);
                            ...
                            f = q
                                ...
                                m && 122 >= m || 65 <= m && 90 >= m || 48 <= m && 57 >= m || 58 == m || 46 == m || 95 == m || 45 == m) && 35 != m) {
        ...
        M._new = function(a, b, c) {
            if ("number" == typeof a) {
                ...
                c.byteOffset = 0;
                c.buffer = new H(c)
            } else if (x.__instanceof(a,
                    H)) null == b && (b = 0), null == c && (c = a.byteLength - b), c = 0 == b ? a.a : a.a.slice(b, b + c), c.byteLength = c.length, c.byteOffset = b, c.buffer = a;
        ...
        l.hide = function(a) {
            l.displaying && (l.container.style.display = "none", window.document.removeEventListener("click",
                l.hide), l.displaying = !1)
        };
        ...
        Ca.prototype = {
            ...
            loop: function() {
                if (this.player.shouldBePlaying()) {
                    switch (this.metadataMode) {
                        case "icecast":
                            var a =
                                this.player.getCurrentUrl().split("?")[0] + ".xspf";
                            break;
                        case "shoutcast":
            ...
            loadStreamTheWorldEvent: function(a) {
                ...
                a = a.children[0];
                if (a.nodeType != h.Element) throw new p("Bad node type, expected Element but found " +
                    a.nodeType);
                    ...
                    for (a = a.elementsNamed("nowplaying-info"); a.hasNext();) {
                        ...
                        for (b = b.elementsNamed("property"); b.hasNext();) {
                            ...
                            if ("cue_time_start" == c.get("name")) {
                                if (c.nodeType != h.Document && c.nodeType != h.Element) throw new p("Bad node type, expected Element or Document but found " + c.nodeType);
                                c = c.children[0];
                                if (c.nodeType == h.Document || c.nodeType ==
                                    h.Element) throw new p("Bad node type, unexpected " + c.nodeType);
                                    ...
                                    if ("track" == e.nodeName.toLowerCase())
                                        for (e =
                                            ...
                                            if ("title" == f.nodeName.toLowerCase()) {
                                                ...
                                                if (null == c) {
                                                    if (f.nodeType != h.Element) throw new p("Bad node type, expected Element but found " +
                                                        f.nodeType);
                                                ...
                                                if (k) {
                                                    ...
                                                    if ("artist" == f.nodeName.toLowerCase()) {
                                                        if (f.nodeType != h.Document && f.nodeType !=
                                                            h.Element) throw new p("Bad node type, expected Element or Document but found " + f.nodeType);
                                                        c = f.children[0];
                                                        if (c.nodeType == h.Document || c.nodeType == h.Element) throw new p("Bad node type, unexpected " + c.nodeType);
                                                        c = c.nodeValue
                                                    }
        ...
        var F = d.muses.Muses = function(a) {
            ...
            a.autoplay &&
                (this.audio.addEventListener("play", u(this, this.activate)), this.playAudio(!1))
        };
        ...
        F.prototype = {
            ...
            playAudio: function(a) {
                ...
                this.audio.play();
                this.activated && (this.ui.setPlaying(), this.metadataLoader.begin(),
                    this.mustWaitForBuffer = 0 < this.requestedBuffering);
            ...
            checkAudioStatus: function() {
                ...
                0 == a ? (a = "Error al conectar", this.lastMessage != a && this.ui.setError()) : -1 == a ? a = "retry..." : null == a ? a = "init" : 1 == a ? (this.bufferingTimeout--, 0 == this.bufferingTimeout && this.retryAudio(), a = "Buffering... " + Math.round(this.bufferingTimeout / 2), this.lastMessage != a && this.ui.setBuffering()) : 2 == a ? (this.playTimeout--, 0 == this.playTimeout && this.retryAudio(5), a = "Playing... ", this.lastMessage != a && (this.ui.setPlaying(), this.reportLegacyPlayer())) : 4 == a || 3 == a ? "play" == this.desiredStatus ? (a =
                    "Error de red", this.retryAudio(), this.lastMessage != a && this.ui.setError()) : (a = "Stopped.", this.lastMessage != a && this.ui.setStopped()) : (a = "ERROR: " + a, console.log(a));
                this.lastMessage = a
            },
            reportLegacyPlayer: function() {
                if (null != this.src) {
                    ...
                    (null != t[b] ? c.existsReserved(b) : c.h.hasOwnProperty(b)) || (c = this.legacyData, null != t[b] ? c.setReserved(b, !0) : c.h[b] = !0,
                        P.exists(b) ? console.log("COOKIE EXISTS!") : (P.set(b, "1", 43200), b = new T("https://www.muses.org/ws/legacyPlayer"), b.onData = function(a) {
                            console.log(a)
        ...
        z.initialize = function(a, b) {
            ...
            }(window, document, "script", "https://www.google-analytics.com/analytics.js", "ga"), ga("create", "UA-12297597-7", "auto", "musesTracker"), (new G(3E5)).run = function() {
                a.shouldBePlaying() && (b.metric1 = a.ui.getPlayTime(), ga("musesTracker.send", "event", "play", "playing", b))
            })
        };
        var B = d.muses.UI = function(a, b) {
            ...
            this.mainDiv.addEventListener("contextmenu", u(this,
        ...
        B.prototype = {
                ...
                d.onData = function(d) {
                    ...
                    for (d = h.parse(d).elements(); d.hasNext();) {
                        ...
                        if ("ffmp3-skin" != e.nodeName.toLowerCase()) {
                            if (e.nodeType != h.Element) throw new p("Bad node type, expected Element but found " +
                                e.nodeType);
                        ...
                        for (e = e.elements(); e.hasNext();) {
                            g = e.next();
                            c.XmlToLower(g);
                            if (g.nodeType != h.Element) throw new p("Bad node type, expected Element but found " +
                                g.nodeType);
            ...
            setMetadataFromString: function(a) {
                if (this.muses.shouldBePlaying() && this.lastMetadata != a) {
                    var b = a.indexOf(" - ", 0); - 1 != b ? (this.artistText.setText(r.substr(a, 0, b)), this.songTitleText.setText(r.substr(a,
                        b + 3, null))) : (this.artistText.setText(""), this.songTitleText.setText(a));
                    this.lastMetadata = a;
            ...
            showInfo: function(a, b) {
                null == b && (b = !0);
                null ==
                    a ? this.restoreTitle() : (null != this.titleTimer && this.titleTimer.stop(), this.statusText.setText(a), b && (this.titleTimer = new G(2E3), this.titleTimer.run = u(this, this.restoreTitle)))
            },
        ...
        R.__name__ = ["muses", "internationalization",
            "Norwegian"
        ];
        R.__super__ = d;
        ...
        var V = function(a, b) {
            ...
            this.container.onmouseout = function(a) {
                c.mouseDownState.style.opacity =
                    "0";
                c.mouseOverState.style.opacity = "0"
            }
        };
        ...
        ba.prototype = k(C.prototype, {
            configure: function(a) {
                C.prototype.configure.call(this, a);
                null != a.get("imageplay") && -1 == a.get("imageplay").indexOf(".swf") && (this.ui.loadImage(this.playMC, a.get("imageplay")), this.appendChild(this.playMC,
                    !1));
        ...
        Q.prototype = k(C.prototype, {
            ...
            setText: function(a) {
                if ("" == a) this.container.style.opacity = "0";
                    ...
                    var b = a + " &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + a;
                    this.innerDIV.innerHTML != a && this.innerDIV.innerHTML != b && (this.innerDIV.innerHTML =
                        a, this.disableScrolling(), this.container.scrollWidth - 6 > this.styleWidth && (this.scrollDiff = this.container.scrollWidth, this.innerDIV.innerHTML = b, this.scrollDiff -= this.container.scrollWidth, this.scroll()))
                }
            },
            scroll: function() {
                var a = this;
                ...
                G.delay(function() {
                    0 != a.scrollDiff && (a.innerDIV.style.transition = "transform 10000ms", a.innerDIV.style.transitionDelay = "5s", a.innerDIV.style.transform =
        ...
        ca.prototype = k(C.prototype, {
            ...
            drawVHolder: function(a) {
                this.holder.style.top = (1 - this.volume) * (this.height -
                    this.holder.naturalHeight) + "px"
            },
            drawBars: function(a) {
                if (null != this.barColors && 0 != this.barStep && (a = Math.round((this.width - 2 * this.horizMargin) / this.barStep), 0 != a)) {
                    ...
                    if (null == this.bars) {
                        ...
                        for (var e = 0; e < a;) {
                            ...
                            h.style.width = Math.round(this.barWidth) +
                                "px";
            ...
            touchMove: function(a) {
                ...
                this.mouseDown({
                    layerX: a.changedTouches[0].clientX -
                        b.left,
            ...
            configure: function(a) {
                ...
                this.setMode(b);
                if ("holder" == b || "vholder" == b) this.holder = new Image, this.holder.onload = u(this, this.holderLoad), this.ui.loadImage(this.holder,
                    a.get("holderimage")), this.appendChild(this.holder);
                this.draw(this.container);
    ...
    if ("undefined" == typeof musesPlayerCounter) {
        ...
        (function() {
            var d = function() {
                ...
                return -1 == k && 0 < d.indexOf("trident/7.0") ?
                    11 : k
            };
        ...
        d.FlashDetect = function() {
            if (navigator.plugins && 0 < navigator.plugins.length) {
                ...
                for (k = -1, D = 0; D < q.length && -1 == k; D++) {
                    ...
                    u.activeXError || (d.installed = !0, k = q[D].version(u), -1 != k && (u = k, E = u.split(","), r = parseInt(E[0].split(" ")[1], 10), J = parseInt(E[1], 10), K = parseInt(E[2],
                        10), E = E[2], d.raw = u, d.major = r, d.minor = J, d.revision = K, d.revisionStr = E))
                }
        }()
    };
