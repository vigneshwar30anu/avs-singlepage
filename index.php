...
<section id="slider" class="slider-element slider-parallax full-screen force-full-screen">
			...
			<div class="slider-parallax-inner">
				...
				<div class="full-screen force-full-screen dark section nopadding nomargin noborder ohidden" style="background-image: url('<?php echo get_template_directory_uri().'/dist/asset/images/page/main.jpg';?>'); background-size: cover; background-position: center center;">
							...
							<div class="emphasis-title">
								<h1>
									<span class="text-rotater nocolor" data-separator="|" data-rotate="fadeIn" data-speed="6000">
										<span class="t-rotate t700 font-body opm-large-word">Kiwi.|different.|creative.|digital.|vision.</span>
									</span>
								</h1>
							</div>
			...
			<div class="content-wrap nopadding">
					...
					<div class="container clearfix">
						...
						<div class="row topmargin-lg divcenter" style="max-width: 1000px;">
							...
							<div class="col-md-4 bottommargin">
								...
								<div class="team">
									<div class="team-image">
										<img src="<?php echo get_template_directory_uri().'/dist/asset/images/team/1.jpg'?>" alt="John Doe">
							...
							<div class="col-md-4 bottommargin">
								...
								<div class="team">
									<div class="team-image">
										<img src="<?php echo get_template_directory_uri().'/dist/asset/images/team/2.jpg' ?>" alt="Josh Clark">
										<div class="team-overlay">
											<div class="team-social-icons">
												<a href="#" class="social-icon si-borderless si-small si-twitter" title="Twitter">
													<i class="icon-twitter"></i>
							...
							<div class="col-md-4 bottommargin">
								...
								<div class="team">
									<div class="team-image">
										<img src="<?php echo get_template_directory_uri().'/dist/asset/images/team/3.jpg'?>" alt="Mary Jane">
										<div class="team-overlay">
											<div class="team-social-icons">
												<a href="#" class="social-icon si-borderless si-small si-twitter" title="Twitter">
													<i class="icon-twitter"></i>
					...
					<div id="portfolio" class="portfolio grid-container portfolio-nomargin portfolio-full portfolio-masonry mixed-masonry clearfix">
						...
						<article class="portfolio-item pf-media pf-icons wide">
							<div class="portfolio-image">
								<a href="#">
									<img src="<?php echo get_template_directory_uri().'/dist/asset/images/portfolio/mixed/1.jpg'?>" alt="Open Imagination">
								</a>
						...
						<article class="portfolio-item pf-illustrations">
							<div class="portfolio-image">
								<a href="#">
									<img src="<?php echo get_template_directory_uri().'/dist/asset/images/portfolio/mixed/2.jpg' ?>" alt="Locked Steel Gate">
								</a>
								<div class="portfolio-overlay">
									<div class="portfolio-desc">
						...
						<article class="portfolio-item pf-graphics pf-uielements">
							<div class="portfolio-image">
								<a href="#">
									<img src="<?php echo get_template_directory_uri().'/dist/asset/images/portfolio/mixed/3.jpg'?>" alt="Mac Sunglasses">
								</a>
								<div class="portfolio-overlay">
									<div class="portfolio-desc">
						...
						<article class="portfolio-item pf-media pf-icons wide">
							<div class="portfolio-image">
								<a href="#">
									<img src="<?php echo get_template_directory_uri().'/dist/asset/images/portfolio/mixed/4.jpg'?>" alt="Open Imagination">
								</a>
								<div class="portfolio-overlay">
									<div class="portfolio-desc">
										<h3><a href="#">Open Imagination</a></h3>
						...
						<article class="portfolio-item pf-uielements pf-media wide">
							<div class="portfolio-image">
								<a href="#">
									<img src="<?php echo get_template_directory_uri().'/dist/asset/images/portfolio/mixed/5.jpg'?>" alt="Console Activity">
								</a>
								<div class="portfolio-overlay">
									<div class="portfolio-desc">
						...
						<article class="portfolio-item pf-media pf-icons">
							<div class="portfolio-image">
								<a href="#">
									<img src="<?php echo get_template_directory_uri().'/dist/asset/images/portfolio/mixed/6.jpg'?>" alt="Open Imagination">
								</a>
								<div class="portfolio-overlay">
									<div class="portfolio-desc">
										<h3><a href="#">Open Imagination</a></h3>
						...
						<article class="portfolio-item pf-uielements pf-icons">
							<div class="portfolio-image">
								<a href="#">
									<img src="<?php echo get_template_directory_uri().'/dist/asset/images/portfolio/mixed/7.jpg' ?>" alt="Backpack Contents">
								</a>
								<div class="portfolio-overlay">
									<div class="portfolio-desc">
				...
				<div id="section-services" class="page-section notoppadding">
					...
					<div class="row align-items-stretch">
						...
						<div class="col-lg-4 d-none d-md-block" style="background: url(<?php echo get_template_directory_uri().'/dist/asset/images/main-bg.jpg' ?>) center center no-repeat; background-size: cover;"></div>
						<div class="col-lg-8">
							<div>
					...
					<div class="section parallax nomargin dark" style="background-image: url(<?php echo get_template_directory_uri().'/dist/asset/images/page/testimonials.jpg' ?>); padding: 150px 0;" data-bottom-top="background-position:0px 0px;" data-top-bottom="background-position:0px -300px;">
				...
				<div id="section-blog" class="page-section">
							...
							<div class="row topmargin clearfix">
									...
									<div class="row">
										<div class="col-lg-6">
											<div class="entry-image nobottommargin">
												<a href="#"><img src="<?php echo get_template_directory_uri().'/dist/asset/images/blog/1.jpg' ?>" alt="Paris"></a>
											</div>
										</div>
								...
								<div class="ipost col-md-6 bottommargin clearfix">
									<div class="row">
										<div class="col-lg-6">
											<div class="entry-image nobottommargin">
												<a href="#"><img src="<?php echo get_template_directory_uri().'/dist/asset/images/blog/2.jpg' ?>" alt="Paris"></a>
											</div>
										</div>
										<div class="col-lg-6" style="margin-top: 20px;">
								...
								<div class="ipost col-md-6 bottommargin clearfix">
									<div class="row">
										<div class="col-lg-6">
											<div class="entry-image nobottommargin">
												<a href="#"><img src="<?php echo get_template_directory_uri().'/dist/asset/images/blog/3.jpg' ?>" alt="Paris"></a>
											</div>
										</div>
										<div class="col-lg-6" style="margin-top: 20px;">
								...
								<div class="ipost col-md-6 bottommargin clearfix">
									<div class="row">
										<div class="col-lg-6">
											<div class="entry-image nobottommargin">
												<a href="#"><img src="<?php echo get_template_directory_uri().'/dist/asset/images/blog/4.jpg' ?>" alt="Paris"></a>
											</div>
										</div>
										<div class="col-lg-6" style="margin-top: 20px;">
					...
					<div class="container topmargin-lg clearfix">
						...
						<div id="oc-clients" class="owl-carousel topmargin image-carousel carousel-widget" data-margin="80" data-loop="true" data-nav="false" data-autoplay="5000" data-pagi="false" data-items-xs="2" data-items-sm="3" data-items-md="4" data-items-lg="5" data-items-xl="6">
							...
							<div class="oc-item"><a href="#"><img src="<?php echo get_template_directory_uri().'/dist/asset/images/clients/1.png' ?>" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="<?php echo get_template_directory_uri().'/dist/asset/images/clients/2.png' ?>" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="<?php echo get_template_directory_uri().'/dist/asset/images/clients/3.png' ?>" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="<?php echo get_template_directory_uri().'/dist/asset/images/clients/4.png' ?>" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="<?php echo get_template_directory_uri().'/dist/asset/images/clients/5.png' ?>" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="<?php echo get_template_directory_uri().'/dist/asset/images/clients/6.png' ?>" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="<?php echo get_template_directory_uri().'/dist/asset/images/clients/7.png' ?>" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="<?php echo get_template_directory_uri().'/dist/asset/images/clients/8.png' ?>" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="<?php echo get_template_directory_uri().'/dist/asset/images/clients/9.png' ?>" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="<?php echo get_template_directory_uri().'/dist/asset/images/clients/10.png' ?>" alt="Clients"></a></div>
