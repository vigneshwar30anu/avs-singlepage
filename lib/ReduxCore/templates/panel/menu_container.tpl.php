...
<div class="redux-sidebar">
    <div class="redux-sidebar-head">
        <?php if(!empty($avs_theme_options['logo']['url'])) { ?>
    		<div class="redux-logo-main">
                <a href="<?php echo esc_url(home_url('/')); ?>">
                    <img src="<?php echo esc_url($avs_theme_options['logo']['url']); ?>" />
                </a>
            </div>
            <?php } else { ?>
                
            <div class="redux-logo-text"><?php echo esc_html( wp_get_theme()->get('Name') ); ?>
            <span>Version <?php echo esc_attr( wp_get_theme()->version ); ?></span></div>
            <?php } ?>
